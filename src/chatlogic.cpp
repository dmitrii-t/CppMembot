...
ChatLogic::~ChatLogic() {
    ...
    // delete all nodes
    // since the vector _nodes holds smart pointers now no further action needed
    // to clean the memory after use
